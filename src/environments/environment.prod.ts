...
const	TARGET_ALIAS		= process.env.TARGET_ALIAS			|| 'stage';		// Set non-stage deployments explicitly in the target environment
const	THIS_NICKNAME		= process.env.NICKNAME				|| 'starter';
...
export const environment = {
	...
	this:		{ title:	THIS_TITLE,		nickname:	THIS_NICKNAME	},
